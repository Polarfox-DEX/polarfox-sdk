    ...
    describe(`decimals permutation: ${decimals}`, () => {
      ...
      describe('Trade', () => {
        ...
        it('TradeType.EXACT_INPUT', () => {
          ...
          const trade = new Trade(route, inputAmount, TradeType.EXACT_INPUT, ChainId.FUJI)
        ...
        it('TradeType.EXACT_OUTPUT', () => {
          ...
          const trade = new Trade(route, outputAmount, TradeType.EXACT_OUTPUT, ChainId.FUJI)
          expect(trade.route).toEqual(route)
        ...
        it('minimum TradeType.EXACT_INPUT', () => {
          if ([9, 18].includes(tokens[1].decimals)) {
            ...
            const trade = new Trade(route, outputAmount, TradeType.EXACT_INPUT, ChainId.FUJI)
