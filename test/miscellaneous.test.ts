...
describe('miscellaneous', () => {
  it('getLiquidityMinted:0', async () => {
    ...
    const pair = new Pair(new TokenAmount(tokenA, '0'), new TokenAmount(tokenB, '0'), ChainId.FUJI)
  ...
  it('getLiquidityMinted:!0', async () => {
    const tokenA = new Token(ChainId.FUJI, '0x0000000000000000000000000000000000000001', 18)
    const tokenB = new Token(ChainId.FUJI, '0x0000000000000000000000000000000000000002', 18)
    const pair = new Pair(new TokenAmount(tokenA, '10000'), new TokenAmount(tokenB, '10000'), ChainId.FUJI)
  ...
  it('getLiquidityValue:!feeOn', async () => {
    const tokenA = new Token(ChainId.FUJI, '0x0000000000000000000000000000000000000001', 18)
    const tokenB = new Token(ChainId.FUJI, '0x0000000000000000000000000000000000000002', 18)
    const pair = new Pair(new TokenAmount(tokenA, '1000'), new TokenAmount(tokenB, '1000'), ChainId.FUJI)
